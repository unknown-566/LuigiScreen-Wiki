...
- Fixed searchable picker dropdowns closing while moving the mouse over their options
- Prevented picker clicks from being mistaken for card clicks in playlist, event and automation builders
